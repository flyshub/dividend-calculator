...
module.exports = function formatResult(r) {
  return {
    ...
    ttm_dividend: r.dividend.ttm_dividend,
    dividend_yield_ttm_before_tax: r.dividend.dividend_yield_ttm_before_tax,
    ttm_period: r.dividend.ttm_period,
    ttm_source: r.dividend.ttm_source,
    ...
    sustainability_score_100: r.sustainability ? r.sustainability.score_100 : null,
